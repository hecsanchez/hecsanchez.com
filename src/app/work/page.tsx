                ...
                <div className="mt-12">
                    <Wrapper >
                        <div className="relative z-10 max-w-4xl m-auto text-center">
                            <p className="text-md sm:text-lg font-medium tracking-widest antialiased antialiased m-auto text-center">
                                <span className="bg-text">MY WORK</span>
                            </p>
                            <h1 className="text-3xl sm:text-6xl font-bold leading-snug antialiased inline block">
                                Products I&apos;ve built
                            </h1>
                            <p className="text-base sm:text-xl mt-3 max-w-[800px] m-auto antialiased leading-8">I ❤️ building software products, these are just some I&apos;ve built recently.</p>

                        </div>
                    </Wrapper>
                </div>
                <div className="mt-10 mb-20 sm:mt-40 sm:mb-40">
                    <div className="flex flex-wrap max-w-[1200px] m-auto">
                        <div className="sm:flex mt-10 sm:mt-20">
                            ...
                            <div className="sm:w-1/2 p-5 text-md sm:text-lg">
                                <h2 className="font-bold text-2xl mt-2 mb-4 sm:text-4xl sm:mt-5 sm:mb-8">Oppal</h2>
                        ...
                        <div className="flex flex-col-reverse sm:flex-row mt-10 sm:mt-20">
                            <div className="sm:w-1/2 p-5 text-md sm:text-lg">
                                <h2 className="font-bold text-2xl mt-4 mb-4 sm:text-4xl sm:mt-8 sm:mb-8">Productosfera</h2>
                        ...
                        <div className="mt-10 sm:flex sm:mt-20">
                            <div className="sm:w-1/2 p-5 ">
                            ...
                            <div className="sm:w-1/2 p-5 text-md sm:text-lg">
                                <h2 className="font-bold text-2xl mt-4 mb-4 sm:text-4xl sm:mt-8 sm:mb-8">Soul Fitness</h2>
                        ...
                        <div className="flex flex-col-reverse sm:flex-row sm: mt-20">
                            <div className="sm:w-1/2 p-5 text-md sm:text-lg">
                                <h2 className="font-bold text-2xl mt-4 mb-4 sm:text-4xl sm:mt-8 sm:mb-8">Unitrabajos</h2>
